...
Könnt ihr euer Programm für die folgenden Aufgaben erweitern?
    • Verhindert mögliche Fehler und gebt einen Hilfetext in Fehlerfall aus.
    • Zusätzlich zu Integer-Zahlen sollen auch Fließkomma Zahlen (Double) eingegeben
      werden können.
    • Eine beliebige Anzahl von Parametern kann angeben werden.
        o Beachtet dabei mögliche Fehlerfälle.
